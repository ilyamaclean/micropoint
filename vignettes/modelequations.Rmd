...
R_abs=(1-α) R_sw^↓+εR_lw^↓

where R_sw^↓ is downward shortwave radiation, R_lw^↓ is downward longwave radiation and α is the canopy (and combined ground) albedo. Radiation absorbed by the ground surface is then given by
...
Albedos
From Sellers (1985) and Yuan et al (2017) albedos are derived using a two-stream radiative transfer model of the form
